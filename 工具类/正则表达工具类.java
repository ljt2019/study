 ...
 * 3. InternetURL：[a-zA-z]+://[^\s]* 或 /^((http|https)://)?([\w-]+\.)+[\w-]+(/[\w-./?%&=]*)?$/
...
public class RegexUtils {
    ...
    public static void main(String[] args) {
        ...
        boolean flag = regex("222x", isDigital);
     ...
     * 校验数字的表达式
     */
    public final static String isDigital = "^[0-9]*$";
    ...
    private static boolean regex(String str, String regex) {
        return str == null || "".equals(str) ? false : str.matches(regex);
    }
}
